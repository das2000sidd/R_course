...
Primero indico las variables que quiero analizar. Aquí vamos a usar la opcion `method=NA` para indicar que use el test paramétrico o no paramétrico en función de si la variable continua sigue una distribución normal o no
